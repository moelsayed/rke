...
func runKubeController(host *hosts.Host, kubeControllerService v3.KubeControllerService, authorization_mode string) error {
	imageCfg, hostCfg := buildKubeControllerConfig(kubeControllerService, authorization_mode)
...
func buildKubeControllerConfig(kubeControllerService v3.KubeControllerService, authorization_mode string) (*container.Config, *container.HostConfig) {
